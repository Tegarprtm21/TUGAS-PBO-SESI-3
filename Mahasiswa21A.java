...
public class Mahasiswa21A extends Mahasiswa {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<=3;i++){
            ...
            mhs.add(new Mahasiswa21A(nim,nama,nilai));
            System.out.println("=============================================================");
        }
        ...
        mhs.get(3).getNilai()>=0 && mhs.get(3).getNilai()<=100
            ...
            for(int i=0;i<=3;i++){
                if("A".equals(mhs.get(i).getGrade()) || "B".equals(mhs.get(i).getGrade()) || "C".equals(mhs.get(i).getGrade())){
                    jumlahLulus++;
            ...
            System.out.println("");
            for(int i=0;i<=3;i++){
                if("A".equals(mhs.get(i).getGrade())){
                    jumlahNilaiA++;
                    nilaiA.add(mhs.get(i).getNama());
                }
                if("B".equals(mhs.get(i).getGrade())){
                    jumlahNilaiB++;
                    nilaiB.add(mhs.get(i).getNama());
                }
                if("C".equals(mhs.get(i).getGrade())){
                    jumlahNilaiC++;
                    nilaiC.add(mhs.get(i).getNama());
                }
                if("D".equals(mhs.get(i).getGrade())){
                    jumlahNilaiD++;
                    nilaiD.add(mhs.get(i).getNama());
                }
                if("E".equals(mhs.get(i).getGrade())){
                    jumlahNilaiE++;
